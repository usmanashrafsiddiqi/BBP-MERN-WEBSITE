...
const Header = ({
  ...
  showContactInfo = false, // new prop
}) => {
  return (
    <header
      className="relative h-[85vh] bg-cover bg-center rounded-[24px] overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center">
        ...
        <div className="flex flex-col items-center justify-center text-center text-white px-4 h-full">
          <div className="mb-12">
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-wide">{title}</h1>
            <p className="text-3xl md:text-6xl font-bold mt-2">{subtitle}</p>
            <p className="mt-4 text-base md:text-lg max-w-3xl mx-auto font-light">{description}</p>
          </div>
            ...
            <div className="mt-6 max-w-7xl w-full px-4 relative">
              ...
              <div className="bg-white rounded-2xl p-6 pt-10 shadow-lg w-full">
                <div className="flex flex-wrap justify-center gap-4">
                  <input type="text" placeholder="Enter Property, Location..." className="min-w-[250px] px-4 py-2 border rounded-full text-sm" />
