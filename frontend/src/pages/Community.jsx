...
const Community = () => {
   ...
   const communityData = [
  {
    name: t("COMM_DUBAI_CREEK_HARBOUR"),
    description: t("DESC_DUBAI_CREEK_HARBOUR"),
    image: "/dubaiceek.jpg",
  },
  {
    name: t("COMM_DOWNTOWN_DUBAI"),
    description: t("DESC_DOWNTOWN_DUBAI"),
    image: "/downtown.jpg",
  },
  {
    name: t("COMM_ARABIAN_RANCHES"),
    description: t("DESC_ARABIAN_RANCHES"),
    image: "/arabianra.jpg",
  },
  {
    name: t("COMM_DUBAI_MARINA"),
    description: t("DESC_DUBAI_MARINA"),
    image: "/dubaimarina.jpg",
  },
  {
    name: t("COMM_JVC"),
    description: t("DESC_JVC"),
    image: "/village.jpg",
  },
  {
    name: t("COMM_DUBAILAND"),
    description: t("DESC_DUBAILAND"),
    image: "/dubailand.jpg",
  },
  {
    name: t("COMM_EMIRATES_HILLS"),
    description: t("DESC_EMIRATES_HILLS"),
    image: "/hills.jpg",
  },
  {
    name: t("COMM_BUSINESS_BAY"),
    description: t("DESC_BUSINESS_BAY"),
    image: "/bay.jpg",
  },
  {
    name: t("COMM_JEBEL_ALI"),
    description: t("DESC_JEBEL_ALI"),
    image: "/ali.jpg",
  },
  {
    name: t("COMM_AL_BARSHA"),
    description: t("DESC_AL_BARSHA"),
    image: "/BARSHA.jpg",
  },
  {
    name: t("COMM_BURJ_KHALIFA"),
    description: t("DESC_BURJ_KHALIFA"),
    image: "/burj.jpg",
  },
  {
    name: t("COMM_AL_FURJAN"),
    description: t("DESC_AL_FURJAN"),
    image: "/furjan.jpg",
  }
];
    ...
    <div>
      ...
      <div className="p-2 md:p-4 bg-white">
        <Header
          ...
          title= {t("OUR_COMUNITIES")}
          subtitle={t("OUR_COMUNITIES_HEADING")}
          description={t("OUR_COMUNITIES_TEXT")}
          showFilter={false}
