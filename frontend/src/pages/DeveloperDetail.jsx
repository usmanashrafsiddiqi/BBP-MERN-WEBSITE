...
const developerDetails = {
  emaar: {
    ...
    about: 'Emaar is one of the top real estate developers, creating amazing homes, vibrant communities, and iconic landmarks. With projects in over 10 countries, Emaar focuses on residential, commercial, retail, and hospitality developments, making modern living more accessible and enjoyable.',
    features: ['Proven Track Record', 'Innovative Designs', 'Quality Assurance', 'Customer-Centric Approach', 'Sustainable Development', 'Strategic Partnerships', 'Global Presence', 'Investment Potential'],
    whyChoose: `Emaar is well-known for creating beautiful homes with amazing attention to detail...`,
  ...
  damac: {
    ...
    about: 'DAMAC Properties is a premium real estate developer specializing in luxury residential, commercial, and leisure properties across the Middle East.',
    features: ['Luxury Lifestyle', 'Prime Locations', 'Brand Collaborations', 'High Investment Value'],
    whyChoose: `DAMAC is known for its luxurious living spaces and high-profile collaborations with brands like Versace and Fendi.`,
  ...
  sobha: {
    ...
    about: 'Sobha Realty is a renowned developer known for quality construction and in-house craftsmanship, offering a luxury living experience.',
    features: ['In-House Development', 'High Construction Standards', 'Luxurious Designs'],
  ...
  'danube-properties': {
    ...
    about: 'Danube is committed to delivering high-quality homes with accessible payment plans for investors and families.',
    features: ['Affordable Luxury', 'On-Time Delivery', 'Flexible Payment Plans'],
    whyChoose: `Danube Properties blends affordability with top-tier amenities, perfect for first-time buyers and investors.`,
  ...
  ellington: {
    ...
    about: 'Ellington is known for crafting luxurious spaces with a focus on design and lifestyle for the modern resident.',
    features: ['Design-Centric', 'Artistic Living', 'Premium Communities'],
    whyChoose: `Ellington creates homes that emphasize design and visual appeal with unmatched attention to detail.`,
  ...
  samana: {
    ...
    about: 'Samana Developers focuses on innovation and lifestyle integration, offering futuristic real estate solutions in Dubai.',
    features: ['Smart Designs', 'Elegant Finishes', 'Lifestyle Integration'],
    whyChoose: `Samana's properties bring together innovation, style, and comfort to redefine modern living.`,
  ...
  binghatti: {
    ...
    features: ['Brand Collaborations', 'Creative Architecture', 'Luxury Residences'],
    whyChoose: `Known for its striking buildings and brand associations, Binghatti is reshaping Dubai’s skyline.`,
  ...
  azizi: {
    ...
    about: 'Azizi Developments offers a wide range of residences, catering to modern families with transparency and quality.',
    features: ['Strategic Locations', 'Mid-Luxury Segment', 'Customer Satisfaction'],
    whyChoose: `Azizi is trusted for its transparent practices, prime locations, and construction-driven philosophy.`,
